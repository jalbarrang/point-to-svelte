...
/**
 * Edge glow shown while point-to-svelte is active/frozen. Unscoped it hugs the
 * viewport; inside a scoped instance it hugs the scope container's box instead,
 * tracking it across scroll and resize so the glow never tints the host page.
 */
