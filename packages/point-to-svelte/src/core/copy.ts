...
import type { StackFrame } from "./context.js";
import type { SvelteGrabEntry, SvelteGrabStackFrame } from "../types.js";
...
// Strips the raw `source` stack-line text and `args` from the wire payload.
const formatStackFramePayload = (frame: StackFrame): SvelteGrabStackFrame => ({
